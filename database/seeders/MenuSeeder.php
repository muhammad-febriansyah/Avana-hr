...
class MenuSeeder extends Seeder
{
    ...
    private function menus(): array
    {
        return [
            ...
            ['code' => 'leave', 'label' => 'Cuti', 'icon' => 'CalendarCheck', 'permission' => 'leave.view', 'sort' => 6],
            ['code' => 'payroll', 'label' => 'Payroll', 'icon' => 'Wallet', 'permission' => 'payroll.view', 'sort' => 7],
            ['code' => 'approvals', 'label' => 'Persetujuan Saya', 'icon' => 'Inbox', 'route' => 'approvals.index', 'permission' => 'approval.act', 'sort' => 8],
            ['code' => 'approval-workflow', 'label' => 'Alur Persetujuan', 'icon' => 'GitBranch', 'route' => 'approval-workflow.index', 'permission' => 'approval.manage-flows', 'sort' => 9],
            ['code' => 'crm', 'label' => 'CRM', 'icon' => 'Contact', 'permission' => 'crm.view', 'feature' => 'crm', 'sort' => 10],
            ['code' => 'calendar', 'label' => 'Kalender', 'icon' => 'Calendar', 'permission' => 'calendar.view', 'feature' => 'calendar', 'sort' => 11],
            ['code' => 'reports', 'label' => 'Laporan', 'icon' => 'BarChart3', 'permission' => 'reports.view', 'sort' => 12],
            ['code' => 'roles', 'label' => 'Peran & Akses', 'icon' => 'ShieldCheck', 'route' => 'roles.index', 'permission' => 'roles.view', 'sort' => 13],
            ['code' => 'audit', 'label' => 'Audit Log', 'icon' => 'ScrollText', 'route' => 'audit.index', 'permission' => 'audit.view', 'sort' => 14],
            ['code' => 'menu-settings', 'label' => 'Pengaturan Menu', 'icon' => 'SlidersHorizontal', 'route' => 'settings.menus.index', 'permission' => 'menu.manage', 'sort' => 15],
            ['code' => 'settings', 'label' => 'Pengaturan', 'icon' => 'Settings', 'route' => 'profile.edit', 'core' => true, 'sort' => 16],
